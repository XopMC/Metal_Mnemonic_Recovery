...
namespace _sha256
{
    ...
    // Cross-platform helpers keep the old implementation readable and MSVC-safe.
...
#ifdef BSWAP
#define WRITEBE32(ptr,x) *((uint32_t *)(ptr)) = _sha256::byteswap32(x)
#define WRITEBE64(ptr,x) *((uint64_t *)(ptr)) = _sha256::byteswap64(x)
#define READBE32(ptr) (uint32_t)_sha256::byteswap32(*(uint32_t *)(ptr))
#else
